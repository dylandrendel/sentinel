...
gulp.task('scripts', function() {
	var scripts = [
		...
		// End - All BS4 stuff
		`${paths.dev}/js/popper.js/popper.js`,

		// Start - All BSMD stuff
		`${paths.dev}/js/bootstrapmd/bootstrap-material-design.js`,
...
gulp.task('copy-assets', function(done) {
	...
	// Copy all JS files
	var stream = gulp
		.src(`${paths.node}popper.js/dist/**/*.js`)
		.pipe(gulp.dest(`${paths.dev}/js/popper.js`));
	////////////////// End Popper Assets /////////////////////////



	////////////////// All Bootstrap Material Design Assets /////////////////////////
	// Copy all JS files
	var stream = gulp
		.src(`${paths.node}bootstrap-material-design/dist/js/**/*.js`)
		.pipe(gulp.dest(`${paths.dev}/js/bootstrapmd`));

	// Copy all Bootstrap Material Design SCSS files
	gulp
		.src(`${paths.node}bootstrap-material-design/scss/**/*.scss`)
		.pipe(gulp.dest(`${paths.dev}/sass/bootstrapmd`));


	// Copy all Bootstrap SCSS files to ~bootstrap folder
	gulp
		.src(`${paths.dev}/sass/bootstrap4/**/*.scss`)
		.pipe(gulp.dest(`${paths.dev}/sass/bootstrapmd/~bootstrap/scss`));
	////////////////// End Bootstrap Material Design Assets /////////////////////////
